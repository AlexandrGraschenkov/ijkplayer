...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-muxer=mp4" # to enable download m3u8 video to mp4 file
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-muxer=mp3" # to enable download m3u8 video to mp4 file
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-muxer=mkv" # to enable download m3u8 video to mp4 file
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libxavs"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-opencl"

export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --extra-ldflags=-L/Users/alex/Documents/my_projects/LiquidPlayer/ijkplayer2/ios/build/universal/lib"
